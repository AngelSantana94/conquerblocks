  ...
  build: {
    rollupOptions: {
      input: {
        ...
        inteligencia_marketer: resolve(__dirname, "blog/el_desarrollador_full_stack_marketer.html"),
        inteligencia_artificial: resolve(__dirname, "blog/inteligencia_artificial.html"),
        master_ciberseguridad: resolve(__dirname, "cursos/master_en_ciberseguridad.html"),
        inteligencia_artificial: resolve(__dirname, "cursos/master_en_desarrollo _de_inteligencia_artificial.html"),
